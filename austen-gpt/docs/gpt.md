...
This document describes the GPT model we implement, following the "Attention is All You Need" paper.

## Table of Contents

- [Architecture](#architecture)
- [Transformer Block](#transformer-block-blockpy)
  - [Multi-head self-attention](#multi-head-self-attention)
  - [LayerNorm](#layernorm)
  - [Feed-forward network (FFN)](#feed-forward-network-ffn)
- [Combining transformer blocks into GPT](#combining-transformer-blocks-into-gpt-gptpy)
  - [(1) GPT class constructor](#1-gpt-class-constructor)
  - [(2) Forward pass: forward](#2-forward-pass-forward)
  - [(3) Optimizer (configure_optimizers)](#3-optimizer-configure_optimizers)
  - [(4) Token generation: generate](#4-token-generation-generate)
